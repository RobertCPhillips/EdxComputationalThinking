...
class RectangularRoom(object):
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return sum([b for a in self.tiles for b in a])
    ...
    def getRandomPosition(self):
        ...
        """
        row = random.uniform(0,self.height)
        col = random.uniform(0,self.width)
    ...
    def isPositionInRoom(self, pos):
        ...
        w = pos.x
        h = pos.y
        return (0 <= w and w < self.width) and (0 <= h and h < self.height)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.setRobotPositionAndClean(room.getRandomPosition())
        self.setRandomDirection()

    def setRandomDirection(self):
        self.setRobotDirection(random.uniform(0,360))
    
    def setRobotPositionAndClean(self, position):
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        cur = self.getRobotPosition()
        newPos = cur.getNewPosition(self.direction, self.speed)
        
        if self.room.isPositionInRoom(newPos):
            self.setRobotPositionAndClean(newPos)
        else:
            self.setRandomDirection()
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                RandomWalkRobot)
    """
    stepsPerTrial = [runTrial(num_robots, speed, width, height, min_coverage, robot_type) for _ in range(num_trials)]
    #print stepsPerTrial
    return sum(stepsPerTrial) / float(num_trials)
...
runSimulation(4, 1.0, 12, 12, 0.65, 1, StandardRobot)
